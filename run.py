...
def _build_splits_with_cache(params, backbone_name, all_folds):
    """
    ...
    Falls back to the normal dataset_factory pipeline when the cache is absent.
    ...
    if cache_exists:
        ...
        for fold in all_folds:
            ...
            eval_loader = torch.utils.data.DataLoader(
                eval_ds,
                batch_size=1,   # final_test iterates one clip at a time, matching normal eval_batch_size=1
                shuffle=False,
                collate_fn=cached_collate_fn,
                pin_memory=True,
            )
    ...
    # No cache – fall back to the normal (slow) pipeline
...
if __name__ == '__main__':
    ...
    for fi in config_list:
        ...
        # == Intra-dataset testing ==    
            ...
            splits, use_cached = _build_splits_with_cache(params, backbone_name, all_folds)
